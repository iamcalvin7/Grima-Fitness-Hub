...
CREATE TYPE exercise_performance_type AS ENUM (
  'weight_reps', 'bodyweight_reps', 'added_weight_reps',
  'assisted_reps', 'duration', 'distance_time'
);
...
CREATE INDEX exercises_tenant_status_name_idx ON exercises(tenant_id, status, name);
CREATE INDEX exercises_tenant_performance_idx ON exercises(tenant_id, performance_type);
CREATE INDEX exercises_tenant_difficulty_idx ON exercises(tenant_id, difficulty);
...
CREATE INDEX exercise_muscles_tenant_muscle_idx ON exercise_muscles(tenant_id, muscle_key);
CREATE INDEX exercise_muscles_exercise_idx ON exercise_muscles(tenant_id, exercise_id);
